   ...
   <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                   ...
                   <li class="active">
                    ...
                    <li class="active">
                      ...
                      <li class="active">
                        <a href="${pageContext.request.contextPath}/ServletPrestamos?menu=ver"><i class="fa fa-fw fa-edit"></i> Informacion Prestamos</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <c:if test="${creoUsuario!=null}">
                    <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            <i class="fa fa-info-circle"></i>  <Strong>${creoUsuario}</strong>
                        </div>
                    </div>
                </div>
                </c:if>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/ServletRegistrarUsuario">

                           <div class="form-group">
                               <label for="rol">Tipo de Usuario</label>
                               
                               <select id="tipo_usuario" name="ROL" class="form-control">
                                        
                                        <c:forEach var="tipoUsuario" items="${usuarioLogeado.getQuePuedeRegistrar()}">
                            ...
                            <div class="form-group">
                                <label>Nombre</label>
                                <input name="NOMBRE"  class="form-control" placeholder="Nombres y Apellidos">
                            </div>
                            
                            <div class="form-group">
                            
                                    <label for="tipo_documento">Tipo de Documento</label>
                                    <select id="tipo_documento" name="TIPO_DOC" class="form-control">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="text" name="NUM_DOC" class="form-control" placeholder="Numero de documento">
                            </div>
                            ...
                            <input class="form-control" name="DEPARTAMENTO" placeholder="Pais">
                            </div>
