<%-- 
    ...
    Created on : Sep 21, 2015, 1:37:37 PM
    Author     : Juan
--%>
...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="../resources/menu-template/css/bootstrap.min.css" rel="stylesheet">
<!-- Custom CSS -->
    <link href="../resources/menu-template/css/sb-admin.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="../resources/menu-template/css/plugins/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="../resources/menu-template/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            Bienvenido, <%=usuario.getRol()+","+nombre%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Bienvenido</strong>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
    ...
    <!-- jQuery -->
    <script src="../resources/menu-template/js/jquery.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="../resources/menu-template/js/bootstrap.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="../resources/menu-template/js/plugins/morris/raphael.min.js"></script>
    <script src="../resources/menu-template/js/plugins/morris/morris.min.js"></script>
    <script src="../resources/menu-template/js/plugins/morris/morris-data.js"></script>
